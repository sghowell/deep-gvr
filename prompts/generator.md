...
- For literature-grounded threshold-understanding questions, keep the hypothesis literature-backed and scoped to threshold existence or cited threshold regimes; do not restate below-threshold suppression as a fresh simulator-ready prediction unless the prompt explicitly asks for empirical validation.
